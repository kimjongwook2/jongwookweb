...
<head>
    ...
    <title>포트폴리오 준비중입니다</title>

    <meta name="description" content="김종욱, 포트폴리오 입니다">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta property="og:url" content="" />
    <meta property="og:type" content="website" />
    <meta property="og:title" content="김종욱, 포트폴리오 입니다" />
    <meta property="og:description" content="김종욱, 포트폴리오 입니다" />
    ...
    <style type="text/css">
        ...
        html{
            ...
            overflow: hidden;
            animation: zoomin 100s infinite linear;
        }
        .cspio body{
...
<div id="cspio-page">
    <div id="cspio-content">
        ...
        <div id="cspio-description">MAY 2021</div>
        <form id="cspio-form" action="" method="post">
            <div id="cspio-field-wrapper">
                <div class="input-group">
                    <input name="EMAIL" class="form-control input-lg form-el" type="email" placeholder="Email" required />
